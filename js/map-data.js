...
const RAW_ADJ = {
  ...
  escandinavia:  ["europa_norte", "ucrania", "ural"],
  ucrania:       ["europa_norte", "europa_sur", "ural"],
  europa_norte:  ["europa_sur", "europa_oeste"],
  europa_sur:    ["europa_oeste", "medio_oriente", "egipto", "africa_norte"],

  africa_norte:  ["egipto", "africa_este", "congo", "europa_sur", "europa_oeste"],
  ...
  afganistan:    ["china", "india", "medio_oriente", "siberia", "mongolia"],
